...
export default function PsDash({ loggedin, id }) {
    ...
    headers.forEach((header) => {
      ...
      render.push(
        <tr className="tablebody">
          <th
            scope="row"
            class="py-4 px-6 font-medium whitespace-nowrap text-white header1"
          >
            <div
              onClick={() => handleUtilitiesShow(header)}
              className="text-white categories"
            >
              {header}
            </div>
          </th>
          <td class="py-4 px-6 font-medium whitespace-nowrap text-white categories tdata">${categoryUsed}</td>
        </tr>
      );
    });
    return render;
  ...
  return (
    <div>
      ...
      <div className="flex flex-col-2">
        <div>
          ...
          <h3 className="text-2xl font-light mx-[200px] my-[45px]">
            Spent ${perData?.used} out of wallet amount ${perData?.allowance}
      ...
      <TableContainer component={Paper} className="table" sx={{boxShadow: 3, maxWidth: 400}}>
      <Table sx={{ maxWidth: 400 }} aria-label="simple table">
        ...
        "& th": {
          ...
          color: "rgba(96, 96, 96)"
            ...
            <TableCell style={{ fontWeight: 'bold' }} className="header">Category</TableCell>
            <TableCell style={{ fontWeight: 'bold' }} className="header">Spent</TableCell>
